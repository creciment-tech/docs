...
| Event | Fires when |
|-------|-----------|
| `delivery.status_changed` | A delivery transitions between statuses |
| `checkout.paid` | A hosted checkout is paid (payment + reconciliation event) |
...
```json
{
  ...
  "data": {
    ...
    "amount": 14200,
    "currency": "NGN",
    "paystackReference": "chk_9f8e7d6c5b4a",
    "breakdown": { "goodsTotal": 12000, "deliveryFee": 1800, "processingFee": 400 },
    "goods": [{ "id": "sku_1", "name": "Jollof platter", "quantity": 2, "price": 6000 }],
    "subaccountCode": "ACCT_xxxxxxxx",
    "deliveryId": "abc123-def456-ghi789",
    "trackingId": "CHIABC123DEF",
    "customer": { "email": "buyer@example.com", "name": "Ada" },
    "receiver": { "phone": "2348012345678" },
    "dropoffAddress": "12 Awolowo Rd, Ikoyi, Lagos",
    "notes": "Call on arrival",
    "paidAt": "2025-01-15T10:45:00.000Z"
  }
}
```
