...
curl "https://api.chidori.africa/api/payments/get-transaction?reference=order_12345_payment" \
  -H "X-API-Key: sk_live_xxx.yyy"
```
...
const response = await fetch(
  'https://api.chidori.africa/api/payments/get-transaction?reference=order_12345_payment',
  {
    headers: {
...
response = requests.get(
    'https://api.chidori.africa/api/payments/get-transaction',
