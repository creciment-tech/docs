...
response = requests.post(
    'https://api.chidori.africa/enterprise-service/api/pricing/single',
    headers={
        'X-API-Key': 'sk_live_xxx.yyy',
        'Content-Type': 'application/json'
    },
...
| `422` | Out of service area | Pickup or destination falls outside the bike service area. Carries `reason: "OUT_OF_SERVICE_AREA"`. |
