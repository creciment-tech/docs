...
curl "https://api.chidori.africa/api/deliveries/get?trackingId=CHI-ABC123" \
  -H "X-API-Key: sk_live_xxx.yyy"
```
...
const response = await fetch(
  'https://api.chidori.africa/api/deliveries/get?id=abc123-def456-ghi789',
  {
    headers: {
...
response = requests.get(
    'https://api.chidori.africa/api/deliveries/get',
