...
| `delivery:create` | Create and cancel deliveries | `/api/deliveries/create`, `/api/deliveries/create-bulk`, `/api/deliveries/cancel` |
...
delivery:read
```
- `delivery:create` - Create single or bulk deliveries (also required to cancel pending deliveries)
